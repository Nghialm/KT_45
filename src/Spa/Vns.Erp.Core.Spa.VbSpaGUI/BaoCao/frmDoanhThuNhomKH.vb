...
Public Class frmDoanhThuNhomKH
...
#Region "Functions"
    ...
    Private Sub BindDataToCbo()
        ...
        cboLoaiNghiepVu.Properties.DataSource = dt
        cboLoaiNghiepVu.Properties.DisplayMember = "TEN"
        cboLoaiNghiepVu.Properties.ValueMember = "ID"

        TNCommon.SelectFirst(cboLoaiNghiepVu)
    End Sub
    ...
    Private Sub BindDataToGrid()
        ...
        Dim lstDoanhThu As IList(Of SpaRpDoanhThuDTO) = _SpaReportsService.BaoCaoDoanhThuDichVuChiTiet(TuNgay, DenNgay, NhomKhId, LoaiDichVu, Generals.DonviID)
