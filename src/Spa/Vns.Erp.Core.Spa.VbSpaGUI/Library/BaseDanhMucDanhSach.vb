...
Public Class BaseDanhMucDanhSach(Of T, IdT)
    Inherits XtraForm
    ...
    End Sub
    Public Overridable Property FormChiTiet() As BaseDanhMucChiTiet(Of T, IdT)
        Get
            Return m_FormChiTiet
        End Get
        Set(ByVal value As BaseDanhMucChiTiet(Of T, IdT))
            m_FormChiTiet = value
        End Set
    End Property
    Private m_FormChiTiet As BaseDanhMucChiTiet(Of T, IdT)
