...
namespace Vns.Erp.Core.Accounting.Domain
{
	...
	public partial class KtCtHHddv : DomainObject<Guid>, INotifyPropertyChanged
	{
		...
		[DataMember]
		public  string SoSeriHd
		{
			get { return _so_seri_hd; }
			set	
			{
				if ( value != null)
					if( value.Length > 64)
						throw new ArgumentOutOfRangeException("Invalid value for SoSeriHd", value, value.ToString());
				
				_isChanged |= (_so_seri_hd != value); _so_seri_hd = value;
			}
			}
		...
		public  string SoHd
		{
			...
			set	
			{
				if ( value != null)
					if( value.Length > 64)
						throw new ArgumentOutOfRangeException("Invalid value for SoHd", value, value.ToString());
				
				_isChanged |= (_so_hd != value); _so_hd = value;
			}
			}
		...
		public override bool Equals( object obj )
		{
			...
			KtCtHHddv castObj = (KtCtHHddv)obj; 
			return ( castObj != null ) &&
				( this._cth_hddv_id == castObj.CthHddvId);
		}
		...
		public override int GetHashCode()
		{
			...
			int hash = 57; 
			hash = 27 * hash * _cth_hddv_id.GetHashCode();
			return hash; 
		}
		#endregion
