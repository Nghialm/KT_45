...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS06DnService : GenericService<BcKetoan, System.Guid>, IRpLedgerS06DnService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            DonviId = (Guid)lstValues[2];

            return RpLedgerAccountDao.GetDataS06Dn(MaTk, MaTkDu, TuNgay, DenNgay, DonviId);
        }
    }
}
