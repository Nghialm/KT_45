...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS06DnDetailService : GenericService<BcKetoan, System.Guid>, IRpPhieuKeToanService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            return RpLedgerAccountDao.GetDataS06DnWithDetail(MaTk, MaTkDu, Null.NullGuid, TuNgay, DenNgay, DonviId);
        }
    }
}
