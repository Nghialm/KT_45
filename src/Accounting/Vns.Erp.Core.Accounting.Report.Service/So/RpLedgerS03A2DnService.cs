...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS03A2DnService : GenericService<BcKetoan, System.Guid>, IRpLedgerS07DnService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            return RpLedgerAccountDao.GetDataS03A_ThuChi(false, MaTk, MaTkDu, TuNgay, DenNgay, DonviId);
        }
    }
}
