...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS11DnAllService : GenericService<BcKetoan, System.Guid>, IRpLedgerS11DnAllService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            return RpLedgerStoreDao.GetDataS11Dn_All(NgayDk, NgayCk, KhoId, DonviId);
        }
    }
}
