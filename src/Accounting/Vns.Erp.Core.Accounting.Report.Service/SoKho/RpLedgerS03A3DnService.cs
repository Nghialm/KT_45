...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS03A3DnService : GenericService<BcKetoan, System.Guid>, IRpLedgerS03A3DnService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            return RpLedgerAccountDao.GetDataS03A_MuaHang(MaTk, TuNgay, DenNgay, DonviId);
        }
    }
}
