...
namespace Vns.Erp.Core.Accounting.Report.Service
{
    ...
    public class RpLedgerS03A4DnService : GenericService<BcKetoan, System.Guid>, IRpLedgerS03A4DnService
    {
        ...
        public override DataTable GetData(List<object> lstProps, List<object> lstValues)
        {
            ...
            return RpLedgerAccountDao.GetDataS03A_Banhang(MaTk, TuNgay, DenNgay, DonviId);
        }
    }
}
