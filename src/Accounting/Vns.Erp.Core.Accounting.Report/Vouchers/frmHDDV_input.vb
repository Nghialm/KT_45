...
#Region "Variable"
    ...
    Public Property objCtH As KtCtHHddv
    Public Property lstCtD As List(Of KtCtDHddv)
...
#Region "Function"
    ...
    Private Sub InitData()
        ...
        objCtH = KtCtHHddvService.GetById(m_CTH_ID)
        'dt1.Rows(0)("CT_SO") = dt1.Rows(0)("PREFIX_CT") & dt1.Rows(0)("CT_SO")
        lstCtD = New List(Of KtCtDHddv)
        lstCtD.AddRange(KtCtDHddvService.GetByCtHandNghiepVu(m_CTH_ID))
    ...
    Private Function getColumnSum() As Decimal
        ...
        For Each item As KtCtDHddv In lstCtD
            equal = equal + item.DoanhThu
        Next
        Return equal
    End Function
    ...
    Private Sub callReport()
        ...
        For Each tmp As KtCtDHddv In lstCtD
