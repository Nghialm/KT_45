...
Public Class CommonClass
    ...
    ''' <summary>
    ''' Chuyen 1 list object kieu ht_baocaoInfo thanh list Parameter. Su dung de chuyen obj tu bang 
    ''' ht_thamso thanh paramter
    ''' </summary>
    ''' <param name="list_object">List cac object ht_baocaoInfo</param>
    ...
    Public Shared Function TopGroupHtBaoCao(ByVal listBC As List(Of HtBaocao)) As HtBaocao
        ...
        'Dim newList As List(Of HT_BaocaoInfo) = listBC.OrderBy(Function(x) x.TEN_BAOCAO).ToList()(0)
        'Return newList(0)
