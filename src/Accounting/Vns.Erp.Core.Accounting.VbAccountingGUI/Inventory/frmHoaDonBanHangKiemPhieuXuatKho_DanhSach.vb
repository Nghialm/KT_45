...
Public Class frmHoaDonBanHangKiemPhieuXuatKho_DanhSach
...
#Region "Load form"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub frmHoaDonBanHangKiemPhieuXuatKho_DanhSach_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            'obj_loaichungtu = New HT_LoaichungtuInfo
...
#End Region
    ...
    Private Sub LoadGRV(ByVal CTH_XN_ID As Guid)
        ...
        Dim phieuCT_D_NxData As List(Of CtDNx) = New List(Of CtDNx)
        phieuCT_D_NxData.AddRange(_CtDNxService.GetObjectByCTHId(CTH_XN_ID))
    ...
    Private Sub Create()
        'Try
        Dim f As frmHoaDonBanHangKiemPhieuXuatKho_ChiTiet = CType(ObjectFactory.GetObject("frmHoaDonBanHangKiemPhieuXuatKho_ChiTiet"), frmHoaDonBanHangKiemPhieuXuatKho_ChiTiet)
    ...
    Private Sub frmHoaDonBanHangKiemPhieuXuatKho_DanhSach_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Try
