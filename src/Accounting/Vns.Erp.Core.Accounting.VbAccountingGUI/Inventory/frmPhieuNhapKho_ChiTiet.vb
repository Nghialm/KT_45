    ...
    Public Function Show_Form(ByVal ID_CT As Guid, ByVal Ma_Loai_CT As String, ByVal Ten_Loai_CT As String, ByVal lstCTH_G As List(Of Extend.CT_H_GInfo), ByVal eState As DataInputState) As Boolean
        Try
            ...
            If objLoaiChungTu.KhoXuat = 1 Then
                ...
                grvPhieuNhapKho.Columns("MaTkcGiavon").Visible = True
                lblTK.Text = "TK nợ"
            ...
            Else
                ...
                grvPhieuNhapKho.Columns("MaTknGiavon").Visible = True
                lblTK.Text = "TK có"
            End If
...
#Region "Private Function and Procedures"
    ...
    Private Sub SetObjectToControl()
        ...
        If lstobj_ct_d_nx.Count <> 0 Then
            grcPhieuPhapKho.DataSource = lstobj_ct_d_nx
            TongTien()
            RemoveHandler GFilter_TK.ClearFilterData, AddressOf GFilter_TK_ClearFilterData
            If objLoaiChungTu.KhoXuat = 1 Then
            ...
            End If
            AddHandler GFilter_TK.ClearFilterData, AddressOf GFilter_TK_ClearFilterData
        End If
        TongTien()
        '
        ConfigGrid.GridConfig(Me.Name + "?" + "MA_LOAI_CT=" + m_Ma_Loai_CT, grvPhieuNhapKho.Name, grvPhieuNhapKho)
    ...
    Private Sub btnLuu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSav.Click
        Try
            ...
            If GFilter_TK.Tag Is Nothing Then
                If objLoaiChungTu.KhoXuat = 1 Then
                    Message_Warning("Bạn chưa chọn giá trị cho tài khoản nợ")
                Else
                    Message_Warning("Bạn chưa chọn giá trị cho tài khoản có")
                End If
                GFilter_TK.Focus()
                Return
            End If
    ...
    Private Function CheckNull(ByVal lstobj_ct_d_nx As List(Of CtDNx)) As Boolean
        ...
        If VnsCheck.IsNullGuid(GFilter_TK.Tag) Or GFilter_TK.Tag = "" Then
            Message_Warning("Bạn chưa nhập " + lblTK.Text)
            GFilter_TK.Focus()
            Return False
        End If
...
#End Region
    ...
    Private Sub GFilter_ClearFilterData(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GFilter.ClearFilterData
        Try
            GFilter.Text = String.Empty
            GFilter.Tag = String.Empty
    ...
    Private Sub GFilter_TK_FirstBinddata(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GFilter_TK.FirstBinddata
        Try
            GFilter_TK.C_DATA_SOURCE = Vns.Erp.Core.DataHelper.ToDataTable(_DmTaikhoanService.GetAllByDonviID(Generals.DON_VI.Id))
            Select Case objLoaiChungTu.KhoXuat
                Case 0
                    'Xuat kho
