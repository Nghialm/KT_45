...
Public Class frmOpecPhieuBanHang_DanhSach
...
#End Region
    ...
    Private Sub BindingData()
        ...
        cboNte.DataSource = lstNgoaite
    End Sub

    Private Sub Create()
        'Try
        Dim f As frmOpecPhieuBanHang_ChiTiet = CType(ObjectFactory.GetObject("frmOpecPhieuBanHang_ChiTiet"), frmOpecPhieuBanHang_ChiTiet)
