...
Public Class frmOpecPhieuMuaHang_Danhsach
#Region "Property"
...
#End Region
    ...
    Private Sub BindControl()
        ...
        Dim lstCang As List(Of HtDanhmuc) = HtDanhmucService.GetByDoiTuong("CANG")
        cboCang.DataSource = lstCang

        Dim lstPtThanhtoan As List(Of HtDanhmuc) = HtDanhmucService.GetByDoiTuong("HINHTHUC_THANHTOAN")
        cboPtThanhtoan.DataSource = lstPtThanhtoan
    End Sub

    Private Sub Create()
        'Try
        Dim f As frmOpecPhieuMuaHang_ChiTiet = CType(ObjectFactory.GetObject("frmOpecPhieuMuaHang_ChiTiet"), frmOpecPhieuMuaHang_ChiTiet)
