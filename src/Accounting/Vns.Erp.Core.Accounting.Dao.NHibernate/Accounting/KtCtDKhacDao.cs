...
namespace Vns.Erp.Core.Accounting.Dao.NHibernate
{
	...
	{
        #region IDao
        KtCtDKhac IDao<KtCtDKhac, Guid>.Merge(KtCtDKhac entity)
        {
        ...
        KtCtDKhac IDao<KtCtDKhac, Guid>.Save(KtCtDKhac entity)
        {
            if (VnsCheck.IsNullGuid(entity.Id)) entity.Id = Guid.NewGuid();
        ...
        KtCtDKhac IDao<KtCtDKhac, Guid>.SaveOrUpdate(KtCtDKhac entity)
        {
            if (VnsCheck.IsNullGuid(entity.Id)) entity.Id = Guid.NewGuid();
