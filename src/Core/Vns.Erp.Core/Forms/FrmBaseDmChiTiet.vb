...
Public Class FrmBaseDmChiTiet
    ...
    ''' <summary>
    ''' Return Object for edit if using QuickAdd Control
    ''' </summary>
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overridable Function GetEditObject() As Object
        Return ResultObject
    End Function
...
#Region "Event Handle"
    Private Sub CommonInit_KeyDownEventProcess(ByVal sender As Object, ByVal e As KeyEventArgs)
        ...
        'Dim obj As FrmBaseDanhMucDanhSach = TryCast(sender, BaseDanhMucDanhSach(Of T, IdT))
