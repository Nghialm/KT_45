...
namespace Vns.Erp.WcfService
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            //VnsKhoService service = (VnsKhoService)ObjectFactory.GetObject("WcfVnsKhoService");
            //IList<VnsKho> list =service.GetAll();
        ...
        void AuthenticationService_Authenticating(object sender, System.Web.ApplicationServices.AuthenticatingEventArgs e)
        {
            ...
            if (e.Authenticated)
            {
                ...
                response.Headers.Add("AuthCookie", FormsAuthentication.FormsCookieName + "=" + encryptedValue);
                response.Headers.Add("Roles", roles);
