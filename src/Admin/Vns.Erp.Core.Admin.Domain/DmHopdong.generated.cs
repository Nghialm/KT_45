...
namespace Vns.Erp.Core.Admin.Domain
{
    ...
    public partial class DmHopdong : DomainObject<Guid>, INotifyPropertyChanged
    {
        ...
        private Guid _hopdong_id_cha;
        private decimal _cho_phep_sua;
        private decimal _co_su_dung;
        private string _ten_loai_hopdong;
        private decimal _cap;
        private decimal _loai_hopdong;
        ...
        public DmHopdong()
        {
            ...
            _chi_tiet = 0;
            _hopdong_id_cha = new Guid();
            _cho_phep_sua = 0;
            _co_su_dung = 0;
            _ten_loai_hopdong = String.Empty;
            _cap = 0;
            _loai_hopdong = 0;
        ...
        [DataMember]
        public Guid HopdongIdCha
        {
            get { return _hopdong_id_cha; }
            set { _isChanged |= (_hopdong_id_cha != value); _hopdong_id_cha = value; }
        }
        ...
        {
            get { return _ten_loai_hopdong; }
            set
            {
                if (value != null)
                    if (value.Length > 64)
                        throw new ArgumentOutOfRangeException("Invalid value for TenLoaiHopdong", value, value.ToString());

                _isChanged |= (_ten_loai_hopdong != value); _ten_loai_hopdong = value;
            }
        }
        ...
        [DataMember]
        public decimal LoaiHopdong
        {
            get { return _loai_hopdong; }
            set { _isChanged |= (_loai_hopdong != value); _loai_hopdong = value; }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            DmHopdong castObj = (DmHopdong)obj;
            return (castObj != null) &&
                (this._hopdong_id == castObj.HopdongId);
        }
        ...
        public override int GetHashCode()
        {
            ...
            int hash = 57;
            hash = 27 * hash * _hopdong_id.GetHashCode();
            return hash;
        }
        #endregion
