...
{
    public partial class CcCtCcdc : DomainObject<System.Guid>
    {
        #region Declarations
        ...
        private Guid _LyDoTangGiamId = new Guid();
        private string _TenLyDoTangGiam =String.Empty;
        private string _GhiChu = String.Empty;
		private Guid _CthId = new Guid();
		...
		public CcCtCcdc Clone()
        {
            return (CcCtCcdc)this.MemberwiseClone();
        }
		
		public void SetProperty(CcCtCcdc des)
		{
			//ID Field
			Id = des.Id;
			//Non ID Field
			...
			_ThuTu = des.ThuTu;
            _LyDoTangGiamId = des.LyDoTangGiamId;
        ...
        public virtual Guid LyDoTangGiamId
        {
            get { return _LyDoTangGiamId; }
            set
            {
                OnLyDoTangGiamIdChanging();
                _LyDoTangGiamId = value;
                OnLyDoTangGiamIdChanged();
            }
        }
        partial void OnLyDoTangGiamIdChanging();
        partial void OnLyDoTangGiamIdChanged();
