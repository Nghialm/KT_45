...
namespace Vns.Erp.Core.Admin.Domain
{
	...
	public partial class DmTudo5 : DomainObject<Guid>, INotifyPropertyChanged
	{
		...
		private Guid _dm_tudo_5_id; 
		private string _ma_dm_tudo_5; 
		private string _ky_hieu; 
		private string _ten_dm_tudo_5; 
		private string _mo_ta; 
		private Guid _dm_tudo_5_id_cha; 
		...
		private decimal _nguoi_tao; 
		private DateTime _ngay_tao; 
		private decimal _nguoi_sua; 
		...
		public DmTudo5()
		{
				_dm_tudo_5_id =  new Guid(); 
				_ma_dm_tudo_5 =  String.Empty; 
				_ky_hieu =  String.Empty; 
				_ten_dm_tudo_5 =  String.Empty; 
				_mo_ta =  String.Empty; 
				_dm_tudo_5_id_cha =  new Guid(); 
				_chi_tiet = 0; 
				_donvi_id =  new Guid(); 
		...
		[DataMember]
		public  Guid DmTudo5Id
		{
			get { return _dm_tudo_5_id; }
			set { _isChanged |= (_dm_tudo_5_id != value); _dm_tudo_5_id = value; }
			}
		...
		[DataMember]
		public  string MaDmTudo5
		{
			get { return _ma_dm_tudo_5; }
			set	
			{
				if ( value != null)
					if( value.Length > 32)
						throw new ArgumentOutOfRangeException("Invalid value for MaDmTudo5", value, value.ToString());
				
				_isChanged |= (_ma_dm_tudo_5 != value); _ma_dm_tudo_5 = value;
			}
			}
		...
		[DataMember]
		public  string TenDmTudo5
		{
			get { return _ten_dm_tudo_5; }
			set	
			{
				if ( value != null)
					if( value.Length > 128)
						throw new ArgumentOutOfRangeException("Invalid value for TenDmTudo5", value, value.ToString());
				
				_isChanged |= (_ten_dm_tudo_5 != value); _ten_dm_tudo_5 = value;
			}
			}
		...
		[DataMember]
		public  Guid DmTudo5IdCha
		{
			get { return _dm_tudo_5_id_cha; }
			set { _isChanged |= (_dm_tudo_5_id_cha != value); _dm_tudo_5_id_cha = value; }
			}
		...
		public override bool Equals( object obj )
		{
			...
			DmTudo5 castObj = (DmTudo5)obj; 
			return ( castObj != null ) &&
				( this._dm_tudo_5_id == castObj.DmTudo5Id);
		}
		...
		public override int GetHashCode()
		{
			...
			int hash = 57; 
			hash = 27 * hash * _dm_tudo_5_id.GetHashCode();
			return hash; 
		}
		#endregion
