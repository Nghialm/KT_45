...
namespace Vns.Erp.Core.Admin.Domain
{
    ...
    public partial class DmTudo4 : DomainObject<Guid>, INotifyPropertyChanged
    {
        ...
        private Guid _dm_tudo_4_id;
        private string _ma_dm_tudo_4;
        private string _ky_hieu;
        private string _ten_dm_tudo_4;
        private string _mo_ta;
        private Guid _dm_tudo_4_id_cha;
        ...
        public DmTudo4()
        {
            _dm_tudo_4_id = new Guid();
            _ma_dm_tudo_4 = String.Empty;
            _ky_hieu = String.Empty;
            _ten_dm_tudo_4 = String.Empty;
            _mo_ta = String.Empty;
            _dm_tudo_4_id_cha = new Guid();
            _chi_tiet = 0;
            _donvi_id = new Guid();
        ...
        [DataMember]
        public Guid DmTudo4Id
        {
            get { return _dm_tudo_4_id; }
            set { _isChanged |= (_dm_tudo_4_id != value); _dm_tudo_4_id = value; }
        }
        ...
        [DataMember]
        public string MaDmTudo4
        {
            get { return _ma_dm_tudo_4; }
            set
            {
                if (value != null)
                    if (value.Length > 32)
                        throw new ArgumentOutOfRangeException("Invalid value for MaDmTudo4", value, value.ToString());

                _isChanged |= (_ma_dm_tudo_4 != value); _ma_dm_tudo_4 = value;
            }
        }
        ...
        [DataMember]
        public string TenDmTudo4
        {
            get { return _ten_dm_tudo_4; }
            set
            {
                if (value != null)
                    if (value.Length > 128)
                        throw new ArgumentOutOfRangeException("Invalid value for TenDmTudo4", value, value.ToString());

                _isChanged |= (_ten_dm_tudo_4 != value); _ten_dm_tudo_4 = value;
            }
        }
        ...
        [DataMember]
        public Guid DmTudo4IdCha
        {
            get { return _dm_tudo_4_id_cha; }
            set { _isChanged |= (_dm_tudo_4_id_cha != value); _dm_tudo_4_id_cha = value; }
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            DmTudo4 castObj = (DmTudo4)obj;
            return (castObj != null) &&
                (this._dm_tudo_4_id == castObj.DmTudo4Id);
        }
        ...
        public override int GetHashCode()
        {
            ...
            int hash = 57;
            hash = 27 * hash * _dm_tudo_4_id.GetHashCode();
            return hash;
        }
        #endregion
